...
5. If substantive differences are found, summarize the change, and extract the exact quote for the requirement change, preserving necessary context, as shown in the formatting_example above.
6. Only include concrete requirements changes. Do not include: - Version number changes - Standard status changes - Capitalization changes - Punctuation changes - Spacing changes - Formatting changes - Changes in links to other parts of the IG - Changes from ONC to ASTP - Changes in guidance which do not affect how data is exchanged - Changes in examples
   </instructions>
